...
RUN pacman --noconfirm -S zsh starship zsh-completions zsh-syntax-highlighting zsh-autosuggestions git-zsh-completion jdk17-openjdk tar unzip python-pip lynx
