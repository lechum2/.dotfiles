        ...
        require("diffview").setup({
            ...
            keymaps = {
                ...
                view = {
                    ...
                    { "n", "g<C-x>",     actions.cycle_layout,                  { desc =
                ...
                file_panel = {
                    ...
                    { "n", "gf",            actions.goto_file_edit,                { desc =
                    "Open the file in the previous tabpage" } },
                    { "n", "<C-w><C-f>",    actions.goto_file_split,               { desc =
                    "Open the file in a new split" } },
                    { "n", "<C-w>gf",       actions.goto_file_tab,                 { desc =
                    "Open the file in a new tabpage" } },
                    { "n", "i",             actions.listing_style,                 { desc =
                    ...
                    { "n", "<leader>e",     actions.focus_files,                   { desc =
